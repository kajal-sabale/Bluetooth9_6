 ...
 * @author a634941
 * @version 1.0
 * This class is used to send data over connected socket using outputstream.
 */
...
/**
*This class is used for writing data to receiver side.
*/
	...
	private class ConnectedThread extends Thread {
		...
		/**This method is used to send data to other device using mHandlaer
		 * @param bytes
		 */
